...
@property (nonatomic, copy) NSString * _Nullable customizationFileName;
...
- (Builder * _Nonnull)setCustomizationFileName:(NSString * _Nonnull)fileName SWIFT_WARN_UNUSED_RESULT;
